...
class PRESENTER( object ):
	def __init__(self,view,model):
		...
		def listener_Close(self):
			reply = GUI.prompt( self._view,
			                    '¡CONFIRMAR!',
		...
		def listener_FullScreen(self):
			if self._view.isFullScreen():
				...
				self._view.setWindowState(self._view.__previousWindowState)
			else :
	...
	def directDelSimpleComp(item,self._view):
	...
	def simpleCompsTreeItemChanged(self._view):
